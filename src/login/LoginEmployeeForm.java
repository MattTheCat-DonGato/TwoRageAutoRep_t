 ...
 */
public class LoginEmployeeForm extends GridPane
{
    //boxes
    ...
    //labels
    private Label emailLabel = new Label("Enter Employee Email:");
    private Label passwordLabel = new Label("Enter Employee Password:");
    ...
    public LoginEmployeeForm()
       ...
       // passwordLabel.setStyle("-fx-background-color: white");
        ...
        //add to button box
        buttonBox.getChildren().addAll(loginButton, returnButton);
